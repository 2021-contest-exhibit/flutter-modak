                          ...
                          Positioned(
                            ...
                            child: Container(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: 8.0),
                              child: Text(
                                "${widget._currentPage}/${widget.args
                                    .campingImages!.length}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18.0,
                                    color: Colors.white),
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        if (await canLaunch('tel: ${widget.args
                                            .phoneNumber!}')) {
                                          await launch('tel: ${widget.args
                                              .phoneNumber}');
                                        } else {
                                          print("지원하지 않습니다");
                                        }
